        ...
        <el-row :gutter="15">
            ...
            <el-col :span="13">
                ...
                <el-card class="box-card">
                    <div slot="header" class="clearfix">
                        ...
                        <el-button
                                @click="getPage('https://github.com/VINDA-98')"
                                type="primary"
                                plain
                    ...
                    <div class="right" style="float:right;width:520px;">
                        <el-table :data="tableInfo" border height="100">
                            ...
                            <el-table-column  label="所属部门"></el-table-column>
                            <el-table-column  label="用户角色" width="150"></el-table-column> 
                        </el-table>
                    </div>
                </el-card>
                <!-- 功能列表 -->
            ...
            <el-col :span="11">
                <div class="grid-content bg-purple">
                  ...
                  title: '你的答案',
                  artist: '阿冗',
                  src: 'http://music.163.com/song/media/outer/url?id=1400256289',
                  pic: 'https://vinda-edu.oss-cn-shenzhen.aliyuncs.com/bishe/wangyiyun.png?Expires=1610440890&OSSAccessKeyId=TMP.3KdAaaii5FWoKLYyhdXvkUW2UrsrMDQhXBmMbGDBLr47RL4pW73FM4nQSKyRV1ueXbP2z6NqVwL4WwxuX38AkRuxEgSPBA&Signature=x0LfvKcPEi3PdMkHWPlCxFzpu58%3D&versionId=CAEQGxiBgICQycTStxciIGQxOWZkNThjN2Y2ZjRjYjliYjYxMDY0ZDhlMDMyYWJl&response-content-type=application%2Foctet-stream'
              }"
                                :list="musicList"
                        ></aplayer>
                        <el-divider>其他项目</el-divider>
                        <el-row :gutter="20">
                            <el-col :span="6"><div class="grid-content bg-purple"><el-button @click="getPage('http://116.85.25.106/backend/loginPage.do')">疫情管理系统</el-button></div></el-col>
                            <el-col :span="6"><div class="grid-content bg-purple"><el-button @click="getPage('http://www.zykcoderman.xyz/')">Vinda - CSDN</el-button></div></el-col>
                            <el-col :span="6"><div class="grid-content bg-purple"><el-button @click="getPage('https://github.com/VINDA-98/')">Vinda - Githhub</el-button></div></el-col>
                        </el-row>
...
#轮播图
    .el-carousel__item h3 {
     ...
     .el-carousel__item:nth-child(1) {
        ...
        background-image: url("https://vinda-edu.oss-cn-shenzhen.aliyuncs.com/bishe/7.jpg?Expires=1610440876&OSSAccessKeyId=TMP.3KdAaaii5FWoKLYyhdXvkUW2UrsrMDQhXBmMbGDBLr47RL4pW73FM4nQSKyRV1ueXbP2z6NqVwL4WwxuX38AkRuxEgSPBA&Signature=DUpxSRsAxmncHnZ4dAGbgU%2FHKgc%3D&versionId=CAEQGxiBgIC.uKnStxciIDAwNjM0MTRlZDIxMTRhYWViMTdjNTYyNDdlM2ZhZWVi&response-content-type=application%2Foctet-stream");
        background-size: 100% 100%;
    } 

    .el-carousel__item:nth-child(2n) {
        background-color: #99a9bf;
        background-image: url("https://vinda-edu.oss-cn-shenzhen.aliyuncs.com/bishe/32.jpg?Expires=1610440853&OSSAccessKeyId=TMP.3KdAaaii5FWoKLYyhdXvkUW2UrsrMDQhXBmMbGDBLr47RL4pW73FM4nQSKyRV1ueXbP2z6NqVwL4WwxuX38AkRuxEgSPBA&Signature=auH62LG209ilwao3ZRIKR5PB1nk%3D&versionId=CAEQGxiBgIC94KrStxciIGVjZTk0OWI3MTliYzQ0NWVhOWFmNDY5NmQyYWVjOTcy&response-content-type=application%2Foctet-stream");
        background-size: 100% 100%;
    }

    .el-carousel__item:nth-child(2n + 1) {
        background-color: #d3dce6;
        background-image: url("https://vinda-edu.oss-cn-shenzhen.aliyuncs.com/bishe/66.jpg?Expires=1610440809&OSSAccessKeyId=TMP.3KdAaaii5FWoKLYyhdXvkUW2UrsrMDQhXBmMbGDBLr47RL4pW73FM4nQSKyRV1ueXbP2z6NqVwL4WwxuX38AkRuxEgSPBA&Signature=0XimdTMEm8puOu0rdzBo3Q3nU%2FI%3D&versionId=CAEQGxiBgMCH_anStxciIDc4NzYwNTZjYThkNjQ4YjM4NTIzYzZhZTczMjhjYmQ1&response-content-type=application%2Foctet-stream");
        background-size: 100% 100%;
    }
</style>
